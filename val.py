...
def run(
    ...
    # patch_transformer = PatchTransformer_denoise().cuda()
    ...
    # Plots
    if plots:
        confusion_matrix.plot(save_dir=os.path.join(save_dir, 'out'), names=list(names.values()))
...
def parse_opt():
    ...
    parser.add_argument('--patch_name', default=None, type=str)
